...
import {Paper,Button,Grid, TextField, IconButton,MenuItem,Card,Chip} from '@mui/material';
...
const Quizform = () => {
  ...
  async function insert(e){
    ...
    const url='http://localhost:5000/insertquiz';
...
<Grid item  md={12}>
    <h6 align='center' className='quizheading'>Quiz No {quiz.number}.</h6>
</Grid>
...
<Button onClick={(event)=>insert(event)} variant='contained' className='quizbutton'sx={{paddingLeft:'30px',paddingRight:'30px', backgroundColor: '#346448' }} >Save</Button>
    </Grid>
      </Grid>
      </Card>
     </Paper>
